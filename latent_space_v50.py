...
def run_latent_mapping(
    ...
    if generate_overlay and clusters > 0:
        print("🧠 Triggering SHAP × Violation overlay by cluster...")
        subprocess.run([
            "python", "generate_shap_overlay_per_cluster.py",
            "--cluster-csv", csv_path,
            "--shap-file", "outputs/shap_overlay.json",
            "--violation-file", "constraint_violation_log.json",
